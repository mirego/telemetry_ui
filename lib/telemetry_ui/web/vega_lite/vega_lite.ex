defmodule TelemetryUI.Web.VegaLite do
  ...
  def draw(spec, metric, assigns) do
    ...
    ~H"""
    <div class="vega-lite-metric group relative flex flex-col bg-white dark:bg-black/40 text-slate dark:text-white p-3 pt-2 border border-black/5 dark:border-white/20 rounded-lg min-h-[220px] h-full">
